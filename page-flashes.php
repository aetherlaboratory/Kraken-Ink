...
<h1 class="text-center"> Flash Sheets</h1>
...
<div class="grid">
   ...
   <?php
	   $args = array(
  'post_type' => 'flash', // Assuming 'tattoo' is your CPT
  'posts_per_page' => 8,
...
<div class="details">
<ul>
<li><i class="icon icon-camera"></i><span>iPad Pro & Apple Pencil</span></li>
<li><i class="icon icon-focal_length"></i><span>Procreate</span></li>
<li><i class="icon icon-aperture"></i><span>Lineart</span></li>
</ul>
</div>
</div>
</a>
